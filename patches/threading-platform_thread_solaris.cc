diff --git a/base/threading/platform_thread_solaris.cc b/base/threading/platform_thread_solaris.cc
new file mode 100644
index 0000000..8a3e73c
--- /dev/null
+++ b/base/threading/platform_thread_solaris.cc
@@ -0,0 +1,115 @@
+// Copyright (c) 2012 The Chromium Authors. All rights reserved.
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+// cribbed initially from platform_thread_linux.cc
...
+
+#ifdef THIS_IS_HOW_LINUX_DOES_IT_BUT_NOT_NACL
